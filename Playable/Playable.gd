...
func _ready():
	...
	var clock_duration
	if GameSettings.m_game_difficulty == GameSettings.DIFFICULTY.EASY:
		clock_duration = 0.2
	elif GameSettings.m_game_difficulty == GameSettings.DIFFICULTY.NORMAL:
		clock_duration = 0.1
	elif GameSettings.m_game_difficulty == GameSettings.DIFFICULTY.HARD:
		clock_duration = 0.05
